...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/pages/account/index/app.vue
//
//
//
//
...
/* harmony default export */ var app = ({
    ...
    methods: {
        ...
        deleteAccount: function deleteAccount(id) {
            if (window.native) {
                var res = native.deleteAccount(id);
                this.getAllAccounts();
            } else {
                console.log("deleteAccount", JSON.stringify(this.accounts.filter(function (i) {
                    return i.id === id;
                })));
            }
        }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-34c52030","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/account/index/app.vue
var app_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',_vm._l((_vm.accounts),function(item){return _c('div',{staticClass:"account-item"},[_c('div',{staticClass:"account-content"},[_c('div',{staticClass:"account-time"},[_vm._v(_vm._s(item.date)+" "+_vm._s(item.time))]),_vm._v(" "),_c('div',{staticClass:"account-cost"},[_vm._v("￥"+_vm._s(item.cost))]),_vm._v(" "),_c('div',{staticClass:"account-serial"},[_vm._v(_vm._s(item.serial))])]),_vm._v(" "),_c('div',{staticClass:"account-action"},[_c('v-btn',{attrs:{"color":"error","small":""},on:{"click":function($event){_vm.deleteAccount(item.id)}}},[_vm._v("delete")])],1)])}))])}
var staticRenderFns = []
var esExports = { render: app_render, staticRenderFns: staticRenderFns }
/* harmony default export */ var index_app = (esExports);
// CONCATENATED MODULE: ./src/pages/account/index/app.vue
...
/* harmony default export */ var account_index_app = (Component.exports);
...
// CONCATENATED MODULE: ./src/pages/account/index/app.js
...
window.vm = new vue_runtime_esm["a" /* default */]({
    el: '#app',
    render: function render(h) {
        return h(account_index_app);
    }
});
